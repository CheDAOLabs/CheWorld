...
export const contract_address = "0x033ee652e759d04e7dca711920df8cf889c96b3b7c088653a7d71ad1c247e9bc";
...
export const store = createStore({
    ...
    mutations: {
        ...
        setShowBagModal(state, value) {
            state.showBagModal = value
        },
    ...
    actions: {
        ...
        async unequip(context, item) {
            ...
            console.log("unequip", item, calldata)

            const mintAdventurerTx = {
                contractAddress: contract_address,
                entrypoint: "unequip",
                calldata: calldata,
                metadata: `Un Equipping ${item}!`,
            };
        ...
        async drop_items(context, item) {
            ...
            console.log("drop_items", item, calldata)
